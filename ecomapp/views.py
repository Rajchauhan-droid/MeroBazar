...
def Product_detail(request, slug, id):
    ...
    return render(request, 'home.html', {'data': product, 'related': related_products})
...
class HomeView(EcomMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['myname'] = "Raj chauhan"
        context['product_list'] = Product.objects.all()
        context['total_cart'] = Cart.objects.count()
        ...
        context['carousel_list'] = Carousel.objects.all().order_by('-id')
        return context
...
class KhaltiVerifyView(View):
    def get(self, request, *args, **kwargs):
        ...
        headers = {
            "Authorization": "Key test_secret_key_624204a073e842e3a8c0707526b60768"
        }
...
def brand_product_list(request, brand_id):
    ...
    return render(request, 'brand-product-list.html', {
        'data': data,
    })


# Product List According to Category
def All_product_list(request, cat_id):
...
def contact(request):
    if request.method == 'POST':
        ...
        if f.is_valid():
            ...
            contact_name = f.cleaned_data['contact_name']
            subject = "You have a new Feedback from {}:<{}>".format(
                contact_name, f.cleaned_data['contact_email'])
